...
UsrView.prototype.view = '<tr data-name="$name"><td>$name</td><td>$desc</td><td>$roles</td><td>$access</td></tr>';
...
UsrView.prototype.btns = {
  ...
  remove: '<a href="#" class="btn btn-sm btn-danger user-remove"><i class="glyphicon glyphicon-remove"></i></a>'
};
