...
ObjView.prototype.renderAccess = function (subject) {
  var rights = '';
  if ( typeof this.access.c.blacklist !== 'undefined'
    && this.access.c.blacklist.indexOf(subject) >= 0)
    rights += '**';
  else if (typeof this.access.c[subject] !== 'undefined') {
    rights += 'c';
  ...
  if ( typeof this.access.r.blacklist !== 'undefined'
    && this.access.r.blacklist.indexOf(subject) >= 0)
    rights += '**';
  else if (typeof this.access.r[subject] !== 'undefined') {
    rights += 'r';
  ...
  if ( typeof this.access.w.blacklist !== 'undefined'
    && this.access.w.blacklist.indexOf(subject) >= 0)
    rights += '**';
  else if (typeof this.access.w[subject] !== 'undefined') {
    rights += 'w';
  ...
  if ( typeof this.access.x.blacklist !== 'undefined'
    && this.access.x.blacklist.indexOf(subject) >= 0)
    rights += '**';
  else if (typeof this.access.x[subject] !== 'undefined') {
    rights += 'x';
...
ObjView.prototype.view = '<tr data-name="$name"><td>$name</td><td>$desc</td><td class="mono">$right</td><td>$edit $access $remove</td></tr>';
